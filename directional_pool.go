...
// DirectionalPoolList wraps a list of account-level directional-groups response from a index request
type DirectionalPoolList struct {
	DirectionalPools []DirectionalPool `json:"tasks"`
	Queryinfo        QueryInfo         `json:"queryInfo"`
	Resultinfo       ResultInfo        `json:"resultInfo"`
}

// AccountLevelGeoDirectionalGroupList wraps a list of account-level, geo directional-groups response from a index request
type AccountLevelGeoDirectionalGroupList struct {
...
// AccountLevelIPDirectionalGroupList wraps an account-level, IP directional-group response
type AccountLevelIPDirectionalGroupList struct {
	AccountName string                           `json:"zoneName"`
...
func (s *GeoDirectionalPoolsService) SelectWithOffset(k GeoDirectionalPoolKey, query string, offset int) ([]AccountLevelGeoDirectionalGroup, ResultInfo, *http.Response, error) {
	var tld AccountLevelGeoDirectionalGroupList
...
func (s *IPDirectionalPoolsService) SelectWithOffset(k IPDirectionalPoolKey, query string, offset int) ([]AccountLevelIPDirectionalGroup, ResultInfo, *http.Response, error) {
	var tld AccountLevelIPDirectionalGroupList
